...
public class EventHandlerProviderTests {
    ...
    public void setUp() {
        ...
        eventHandlerProvider = new EventHandlerProvider(eventHandlerFactory, lifecycleObserver);
        when(eventHandlerFactory.getComponentPool(any(),any(),any())).thenReturn(componentPool);
        when(eventHandlerFactory.getEventDecorator(any())).thenReturn(eventDecorator);
        when(eventHandlerFactory.getEventValidator(any())).thenReturn(eventValidator);
    ...
    public void setConfigsShouldBuildAFullChain() {
        ...
        verify(eventDecorator,timeout(1000)).setNext(componentPool);
